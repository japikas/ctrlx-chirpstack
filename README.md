...
This project aims to support [ISA-95](https://en.wikipedia.org/wiki/ANSI/ISA-95) compliant architectures in Industrial automation and IoT (I-IoT), enabling field deployment of LoRaWAN IoT Network Server with help of **ctrlX** technology.
