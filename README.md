...
This project is published under [MIT License](https://github.com/japikas/ctrlx-chirpstack/blob/main/LICENSE). This project clones but does not fork any of the given OSS projects. The original code base of those projects remain as is, and compatibility with future releases is not guaranteed.
